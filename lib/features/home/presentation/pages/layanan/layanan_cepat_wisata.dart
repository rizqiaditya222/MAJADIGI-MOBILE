...
class LayananCepatWisataPage extends StatefulWidget {
  const LayananCepatWisataPage({super.key});

  @override
  State<LayananCepatWisataPage> createState() =>
      _LayananCepatWisataPageState();
}

class _LayananCepatWisataPageState
    extends State<LayananCepatWisataPage> {
